...
class Zombie:
    ...
    def can_attack(self, current_time: float) -> bool:
        return current_time - self.last_attack_time >= 1000
    ...
    def render(self, screen, camera):
        ...
        if self.health < self.max_health:
            ...
            pygame.draw.rect(screen, RED, (screen_pos[0], screen_pos[1] - 8, bar_width, bar_height))
            pygame.draw.rect(screen, GREEN, (screen_pos[0], screen_pos[1] - 8, int(bar_width * health_percent), bar_height))
